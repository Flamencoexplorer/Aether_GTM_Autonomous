...
import type { AgentLog, LogLevel, AgentName } from '../../../worker/types';
...
const getLogLevelColor = (level: LogLevel) => {
  switch (level) {
    ...
    case 'WARN': return 'text-electric-yellow';
...
export function AgentLogStream() {
  ...
  const filteredLogs = useMemo(() => {
    return logs
      ...
      .filter(log => selectedLevel === 'ALL' || (log.type === 'REASONING' && selectedLevel === 'DEBUG') || (log.type === 'OBSERVATION' && selectedLevel === 'INFO')); // Simplified mapping for demo
