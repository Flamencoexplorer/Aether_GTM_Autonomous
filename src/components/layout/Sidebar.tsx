      ...
      <nav className="flex-1 p-4 space-y-2">
        {navigation.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                'flex items-center px-4 py-3 text-sm font-bold uppercase tracking-widest border-2 border-transparent transition-colors',
                isActive
                  ? 'bg-electric-yellow text-background border-foreground'
